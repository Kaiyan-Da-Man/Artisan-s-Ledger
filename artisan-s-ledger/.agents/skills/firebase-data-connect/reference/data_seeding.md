...
mutation SeedIndependentTables @transaction {
    ...
    movie_insertMany(data: [{ id: "m-1", title: "Inception", genre: "sci-fi" }, { id: "m-2", title: "The Matrix", genre: "action" }])
    ...
    movieActor_insertMany(data: [{ movie: { id: "m-1" }, actor: { id: "a-1" }, role: "main" }, { movie: { id: "m-2" }, actor: { id: "a-2" }, role: "main" }])
}
```
